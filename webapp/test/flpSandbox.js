		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JPC Approval",
									"targetURL": "#comsapjpcapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapjpcapproval-display": {
								"semanticObject": "comsapjpcapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.jpcapproval",
									"url": sap.ui.require.toUrl("com/sap/jpcapproval")
								}
							}
						}
					}
