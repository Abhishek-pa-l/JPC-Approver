    ...
    function (Controller) {
        ...
        return Controller.extend("com.sap.jpcapproval.controller.View1", {
            ...
            initRichTextEditor2: function (bIsTinyMCE5) {
                var that = this,
                sHtmlValue = '<table style="border-collapse: collapse ; width: 100%" border="1"><colgroup><col style="width: 33.3053%"><col style="width: 33.3053%"><col style="width: 33.3053%"></colgroup>                <tbody>                <tr>                        <td>col1</td>                        <td>col2</td>                        <td>col3</td>                    </tr><tr>                            <td>col11</td>                            <td>col22</td>                            <td>col33</td>                        </tr>                </tbody>                </table>                <p><strong>To request JPC approval to amend Contract xxxxxx as follows:</strong></p><p>&nbsp; &nbsp; <span style="color: gold">a. extend the contract duration for an additional period of [Please state] from [Please state] to [Please state], </span></p><p>&nbsp; &nbsp; <span style="color: deepskyblue">b. amend Schedules B and C without any increase in value/ increase of contract value by [Please state in Contract currency] (USD [Please state]) resulting in a revised&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Total Contract Value of [Please state in Contract currency] (USD [Please state]) as described herein. </span></p><p>&nbsp; &nbsp;<span style="color: darkmagenta"> c. Increase in value by [Please state in Contract currency] (USD [Please state]) resulting in a revised Total Contract Value of [Please state in Contract currency] (USD&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;[Please state]) as described herein.</span></p><p><span style="color: darkmagenta">&nbsp; &nbsp;d. amend Form of Agreement in order to remove Contract Ceiling Value and Schedule E in order to update the Articles related to Contract Ceiling Value. [strike out&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; whichever is not applicable].&nbsp;</span></p>';
            ...
            www: function () {
                let value = sap.ui.getCore().byId("myRTE").getValue()
                let value2 = sap.ui.getCore().byId("myRTE2").getValue()
